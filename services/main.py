...
from configs import base_string,configurations,QUERY_PATH,INDEX_NAME,configurations_new,configurations_newv2
...
if(decisionbox=="1"):
    ...
    start_elastic_service(index_name=INDEX_NAME,corpus=corpus,configurations=configurations_newv2)
elif(decisionbox=="2"):
